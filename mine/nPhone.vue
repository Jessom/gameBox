	...
	<view class="nickname-page">
		<u--form :model="form" label-width="60" ref="form1">
			<u-form-item label="手机号" prop="phone" borderBottom style="background-color: #fff; padding: 0 20rpx">
				<u--input v-model="form.phone" border="none" placeholder="请输新手机号"></u--input>
			</u-form-item>
		...
		<view class="foot-btn">
			<u-button type="primary" shape="circle" :disabled="!form.nickname" text="下一步" @click="onSubmit"></u-button>
		</view>
