<template>
	<w-login className="login-page">
		...
		<u-button type="primary" class="login-btn" :disabeld="!form.username && !form.password" @click="onSubmit" shape="circle">登录</u-button>
		
		<view class="login-small-btn" @click="onNavigator('/mine/register')">注册账号</view>
...
<script>
import { login } from '@/common/apis/user.api.js'
